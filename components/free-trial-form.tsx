...
const coverageAreas = {
  ...
  norteCauca: ["Santander de Quilichao", "Guachené", "Caloto"],
}
                  ...
                  <div className="mt-2 border border-gray-200 rounded-lg overflow-hidden">
                    <div className="flex border-b">
                      <button
                        ...
                        className={`flex-1 py-2 px-3 text-sm ${selectedArea === "cali" ? "bg-blue-50 text-raicesBlue font-medium" : "text-gray-600"
                          }`}
                      >
                        Cali
                      </button>
                      <button
                        ...
                        className={`flex-1 py-2 px-3 text-sm ${selectedArea === "jamundi" ? "bg-blue-50 text-raicesBlue font-medium" : "text-gray-600"
                          }`}
                      >
                        Jamundí
                      </button>
                      <button
                        ...
                        className={`flex-1 py-2 px-3 text-sm ${selectedArea === "norteCauca" ? "bg-blue-50 text-raicesBlue font-medium" : "text-gray-600"
                          }`}
                      >
                        Norte Cauca
                      </button>
                      ...
                      <RadioGroup value={selectedLocation || ""} onValueChange={setSelectedLocation}>
                        <div className="grid grid-cols-2 gap-2">
                          {coverageAreas[selectedArea as keyof typeof coverageAreas].map((location) => (
                            <div
                              key={location}
                              className={`flex items-center space-x-2 p-2 rounded-lg cursor-pointer transition-colors ${selectedLocation === location
