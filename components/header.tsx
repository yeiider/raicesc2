...
export function Header() {
    ...
    return (
        <header className="sticky top-0 z-50 w-full bg-white shadow-md">
            <div className="container mx-auto px-4 py-3 flex flex-col md:flex-row md:items-center md:justify-between">
                <div className="flex items-center justify-between">
                    <Link href="/" className="flex items-center">
                        <Image src="/images/logo.png" alt="RAICES Logo" width={150} height={60}
            ...
            <div
                className="hidden md:block h-1 w-full bg-gradient-to-r from-raicesRed via-raicesBlue to-raicesRed"></div>
        </header>
    )
}
